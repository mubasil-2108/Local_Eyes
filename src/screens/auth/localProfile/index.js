...
export default function Index(props) {
    ...
    return (
        <Wrapper isMain backgroundColor={colors.appBgColor2} style={[{}]}>
            ...
            <Wrapper backgroundColor={'pink'} marginHorizontalSmall style={{ marginTop: width(5) }}>
                <Headers.Primary
                    onBackPress={() => goBack()}
                    showBackArrow
            ...
            <Wrapper alignItemsCenter justifyContentCenter>
                <Wrapper alignItemsCenter flexDirectionRow>
                    <Wrapper style={{ flex: 0.2, borderRadius: 20, height: height(0.7), marginHorizontal: sizes.horizontalLineHeight }} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} isGradient gradiantColors={[colors.appColor5, colors.appColor5, colors.appColor3]} />
                    <Wrapper style={{ flex: 0.2, borderRadius: 20, height: height(0.7), marginHorizontal: sizes.horizontalLineHeight }} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} isGradient gradiantColors={[colors.appColor5, colors.appColor5, colors.appColor3]} />
                    <Wrapper style={{ flex: 0.2, borderRadius: 20, height: height(0.7), marginHorizontal: sizes.horizontalLineHeight }} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} isGradient gradiantColors={[colors.appColor5, colors.appColor5, colors.appColor3]} />
                </Wrapper>
            </Wrapper>
            <ScrollViews.KeyboardAvoiding>
                ...
                {/* <Wrapper backgroundColor={'red'} paddingVerticalTiny marginHorizontalBase style={{ marginTop: width(5) }}>
            ...
            <Wrapper background1 paddingVerticalBase marginHorizontalBase >
                <Buttons.Colored
